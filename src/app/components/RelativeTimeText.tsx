...
export const RelativeTimeText = ({ time, baseTime, defaultToTime, lowercase, showSeconds }: RelativeTimeTextProps) => {
  ...
  if (useRelative) {
    ...
    text = formatDate(time, `EEE yyyy-MM-dd HH:mm${showSeconds ? ':ss' : ''}`);
  }
